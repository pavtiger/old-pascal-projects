...
var H, EarthX, EarthY, RingH, HeightObject, R, Count, Step, WhiteOrTranparent, 
  ...
  ReadyToFall, Test, NLevels, CaptureReady, StartPlay, SaturnVHeightNoFire: integer;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  begin
    ...
    StepTriangleFall:=12;
    AddH:=30;
    StepObject:=random(20, 30)/10; //Making Water.mpeg
    CaptureH:=40;
    Gotcha:=0;
    GoBack:=0;
    GoBackStep:=0.18;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    TextOut(10, 10, (DXCapture+DYCapture)/2);
    redraw();
