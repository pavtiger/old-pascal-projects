...
var X, Y, StartX, StartY, XTr, YTr, iTr, RTr, XSaturn1, YSaturn1, XSaturn2, 
  ...
  Between, StartITr, AddH, StepObject, i, RocketR, RocketI, Minus, DXCapture, DYCapture, CaptureH: real;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    begin
      ...
      begin
        ...
        DXCapture:=XRocket-X;
        DYCapture:=YRocket-Y;
        if (RocketR<=R) and ((DXCapture<CaptureH) or (DYCapture<CaptureH)) then
        begin
          sleep(1000);
        end;
      end;
