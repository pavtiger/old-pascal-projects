...
var X, Y, StartX, StartY, XTr, YTr, iTr, RTr, XSaturn1, YSaturn1, XSaturn2, YSaturn2, 
  dx, dy, Stepi, StepR, ask, HSaturn1, iSaturn1, HSaturn2, iSaturn2, flightH1, H2, DI, XRocket, 
  YRocket, XSaturnHeight, YSaturnHeight, SaturnTriangle, TriangleX1, TriangleY1, 
  TriangleX2, TriangleY2, FlightH, Flighti, StepTriangle, Fi, H1, StepRocket: real;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {==}procedure SaturnLiftoffDraw(flight: real);
  begin
    if flight=0 then
    begin
    ...
    XRocket:=StartX + (((H+(H2-H1))/2)+flight)*cos((((H/2+flight+DI/2)*-1)+90)*Pi/180);
    YRocket:=StartY + (((H+(H2-H1))/2)+flight)*sin(((H/2+flight+DI/2)+90)*Pi/180);
