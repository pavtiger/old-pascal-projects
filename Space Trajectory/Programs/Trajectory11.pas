...
var X, Y, StartX, StartY, XTr, YTr, iTr, RTr, XSaturn1, YSaturn1, XSaturn2, YSaturn2, 
  ...
  TriangleX2, TriangleY2, FlightH, Flighti, StepTriangle, Fi: real;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  begin
    ...
    XRocket:=StartX + ((H+(H2-H1))/2)*cos((((H/2+DI/2)*-1)+90)*Pi/180);
    YRocket:=StartY + ((H+(H2-H1))/2)*sin(((H/2+DI/2)+90)*Pi/180);
