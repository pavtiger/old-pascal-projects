...
var H, EarthX, EarthY, RingH, HeightObject, R, Count, Step, WhiteOrTranparent, 
  ...
  ReadyToFall, Test, NLevels, CaptureReady, StartPlay: integer;
var X, Y, StartX, StartY, XTr, YTr, iTr, RTr, XSaturn1, YSaturn1, XSaturn2, 
  ...
  HDownUp, ChangeH, TowerTriangle, fall, 
  StartFalli, Fr, StepRocketR, StepRocketI, FallCount, SaturnRocketTriangle, StepTriangleFall, 
  Between, StartITr, AddH, StepObject, i, RocketR, RocketI, Minus, DXCapture, DYCapture, CaptureH, GoBackStep, GoBack, TriangleR1, TriangleR2: real;
...
////////////////////////////////////////////////////////////////////////////////
begin
  mp3_LiftOff.Open(new System.Uri('C:\PABCWork.NET\File Programs\!Space Trajectory\LiftOff.mp3', System.UriKind.Relative));
  MaximizeWindow;
  OnKeyDown := KeyDown;
  //OnKeyUp := KeyUp;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    begin
      ...
      begin
        ...
        if (TriangleR1<=R) and ((DXCapture<CaptureH) or (DYCapture<CaptureH)) then
        begin
          CaptureReady:=1;
        end;
        if (TriangleR1>R) and (Gotcha<>1) and ((DXCapture<CaptureH) or (DYCapture<CaptureH)) then
        begin
          sleep(0);
        end;
      end;
