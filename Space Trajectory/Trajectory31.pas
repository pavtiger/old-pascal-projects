...
var Stars, Planet, EarthObject, SaturnV1, DeathStar, Tower, ResultStar: Picture;
var H, EarthX, EarthY, RingH, HeightObject, R, Count, Step, WhiteOrTranparent, 
  ...
  ReadyToFall, Test, NLevels, CaptureReady, StartPlay, SaturnVHeightNoFire, BadCapture, BreakDoAway: integer;
