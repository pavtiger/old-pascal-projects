...
void setup(void) {
  ...
  while(1) {
    ...
    Minutes++;
    numberOutput(Minutes%10, 30, 78, 13, MAGENTA);//D

    if (Minutes%10 == 0) {
      numberOutput(Minutes/10, 30, 58, 13, MAGENTA);//C
    }
    
    if (Minutes>=60) {
      Minutes=0;
      Hours++;
      numberOutput(Hours%10, 30, 21, 13, MAGENTA);//B
      numberOutput(Minutes/10, 30, 58, 13, MAGENTA);//C
      if (Hours%10 == 0) {
        numberOutput(Hours/10, 30, 1, 13, MAGENTA);//A
      }
    }
