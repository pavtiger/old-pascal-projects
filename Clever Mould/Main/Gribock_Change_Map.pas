...
var size_x: array [1..4] of integer = (601, 601, 767, 837);
var size_y: array [1..4] of integer = (498, 498, 669, 682);
var pictures: array [1..4] of string = ('Add.png', 'no.png', 'Big.png', 'Lab.png');
var pic: Picture;
