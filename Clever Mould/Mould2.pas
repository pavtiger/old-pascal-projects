...
var b: boolean;
var rand, rezim, Cheat, CheatRezim: integer;
    ...
    begin
      ...
      begin
            ...
            rand := 5;
              ...
              begin
                  rand += 15;              //+= round(Good[y][x] * 50)
                  //rand += round(Good[y][x] * 50);
...
begin
    ...
    else if((l = 3)and(Map[y3][x3] <> -1))then
    begin
...
begin
  ...
  SIZEY:=401;
  SIZEX:=501;
  StartPoint[1]:=301;//round(SIZEX/2);//X 
  StartPoint[2]:=301;//round(SIZEX/2);//Y
  ...
  begin
    ...
    begin
        ...
        begin
          ...
          begin
              Asstar(per + 1, x, y, StartPoint[1], StartPoint[2]);
              Tr2[y - 2][x - 2] := true;
              Tr2[y + 2][x + 2] := true;
              Tr2[y + 2][x - 2] := true;
              Tr2[y - 2][x + 2] := true;
