...
begin
  ...
  begin
    ...
    begin
      ...
      {2, x} arrTriangles[I, 2, 1]:= x1+round(H/2);
      {2, y} arrTriangles[I, 2, 2]:= y1+round(H/2*Sqrt(3)/2);
      {2, x} arrTriangles[I, 2, 3]:= x1;
      {2, y} arrTriangles[I, 2, 4]:= y1-round(H/2*Sqrt(3)/2);
      
      {3, x} arrTriangles[I, 3, 1]:= x1-round(H/2)-3;
      {3, y} arrTriangles[I, 3, 2]:= y1+round(H/2*Sqrt(3)/2);
      {3, x} arrTriangles[I, 3, 3]:= x1+round(H/2)+5;
      {3, y} arrTriangles[I, 3, 4]:= y1-round(H/2*Sqrt(3)/2);
